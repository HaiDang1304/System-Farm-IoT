...
const Sidebar = ({ isOpen, setIsOpen }) => {
  ...
  const MenuItems = () => (
    <>
      <button
        ...
        className="w-full text-left px-4 py-2 rounded hover:bg-gray-700 flex items-center gap-2"
      >
        <svg
  ...
  return (
    <>
      {/* Sidebar desktop */}
      <aside className="hidden md:flex flex-col w-64 bg-gray-900 text-white fixed h-screen z-40">
